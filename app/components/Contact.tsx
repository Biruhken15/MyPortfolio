          ...
          <div className="card p-8 md:p-12 animate-fade-in-up animation-delay-300">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <a href="https://github.com/Biruhken21" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-lg hover:bg-gray-50 transition-all group animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                    <div className="p-3 rounded-lg bg-gray-50 group-hover:bg-primary/10 transition-all">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-700 group-hover:text-primary transition-colors">github.com/Biruhken21</p>
                    </div>
                  </a>
